...
# adaped from: https://github.com/Diyago/ML-DL-scripts/blob/master/DEEP%20LEARNING/segmentation/Segmentation%20pipeline/segmentation%20pipeline.py
...
class DataGeneratorFolder(Sequence):
    def __init__(self, root_dir=r'../data/val_test', image_folder='images', mask_folder='label',
    ...
    def __getitem__(self, index):
        ...
        for i, sample_index in enumerate(indexes):
            ...
            # Because test images can have different sizes we resize it to be divisible by 32
...
path_training_data = "./nucleus_data"

test_generator = DataGeneratorFolder(root_dir=path_training_data,
                                     image_folder='images',
                                     mask_folder='label',
                                     batch_size=1,
...
train_generator = DataGeneratorFolder(root_dir=path_training_data,
                                      image_folder='input/',
                                      mask_folder='output/',
